export const getSystemPrompt = (reference?: string, customPrivateLib?: string) => `
# Role: 前端业务组件开发专家
...
- 业务组件中用到的所有组件都来源于 \`import {  } from "${
  customPrivateLib || '@private-basic-components'
}"\` 组件库。
