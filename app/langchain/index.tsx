...
import { usePrivateComponentsStore } from '../store/privateComponentsStore';
...
const Home = () => {
  ...
  const { name: privateComponentsName } = usePrivateComponentsStore();
    ...
    try {
      ...
      const response = await fetch('/api/langchain', {
        ...
        body: JSON.stringify({
          ...
          customPrivateLib: privateComponentsName
        } as OpenAIRequest)
      });
